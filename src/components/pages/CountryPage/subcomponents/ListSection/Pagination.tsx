...
export const Pagination = ({currentRow, setCurrentRow, pagesOffset, refetch}: PaginationProps) => (
  <div className="flex gap-2 rounded-md bg-white lg:px-7 px-3 py-2 shadow-sm">
    <span
      className={clsx(
        "cursor-pointer select-none rounded-md bg-bodyBg px-6 py-4 font-bold",
